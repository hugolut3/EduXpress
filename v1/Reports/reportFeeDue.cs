...
namespace EduXpress.Reports
{
    public partial class reportFeeDue : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void ReportHeader_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            else if ((FeesDueFull == false) && (IsFeesDuePercentage == false))
            {
                xrLblFeesDue.Text = LocRM.GetString("strListStudentsFeesDuePartially");
            }
            else if ((FeesDueFull == false) && (IsFeesDuePercentage == true))
            {
                xrLblFeesDue.Text = LocRM.GetString("strListStudentsFeesDuePartiallyPercentage") + " " + 
                    PercentageFeesDue + "% " + LocRM.GetString("strOfs") + " " + LocRM.GetString("strSchoolFees"); 
            }
