...
{
    public partial class reportBulletinLIT_3 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        ResourceManager LocRM = new ResourceManager("EduXpress.Language.EduXpressStrings", typeof(reportBulletinLIT_3).Assembly);

        public reportBulletinLIT_3()
        {
            InitializeComponent();
        }

        private void reportBulletinLIT_3_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            //Show/hide stamp
            ...
            if (isViewTemplateGlobalVariable == false)
            {
                try
                {
                    ...
                    xrTableEducationLaViePeriode1.Text = pointArrayGlobalVariable[3, 0]; //Ed. Civ. & Morale
                    ...
                    xrTableEdCivMoraleEducationLaViePeriode1.Text = pointArrayGlobalVariable[4, 0]; //Education à la Vie
                    stmarkSubject = xrTableEdCivMoraleEducationLaViePeriode1.Text;
                    canConvert = int.TryParse(stmarkSubject, out intmarkSubject);
                    if (canConvert == true)
                    {
                        intmarkSubject = (intmarkSubject * 100) / maxima1;
                        ...
                        if (intmarkSubject >= 50)
                        {
                            xrTableEdCivMoraleEducationLaViePeriode1.ForeColor = Color.Blue;
                        }
                        else
                        {
                            xrTableEdCivMoraleEducationLaViePeriode1.ForeColor = Color.Red;
                        }
                    }
                    ...
                    xrTableBiologiePeriode1.Text = pointArrayGlobalVariable[7, 0]; //Microbiologie (1)                    
                    stmarkSubject = xrTableBiologiePeriode1.Text;
                    canConvert = int.TryParse(stmarkSubject, out intmarkSubject);
                    if (canConvert == true)
                    {
                        ...
                        if (intmarkSubject >= 50)
                        {
                            xrTableBiologiePeriode1.ForeColor = Color.Blue;
                        }
                        else
                        {
                            xrTableBiologiePeriode1.ForeColor = Color.Red;
                        }
                    }
                    ...
                    xrTableEsthétiquePeriode1.Text = pointArrayGlobalVariable[14, 0]; //Sociologie / Ecopol (1)
                    stmarkSubject = xrTableEsthétiquePeriode1.Text;
                    canConvert = int.TryParse(stmarkSubject, out intmarkSubject);
                    if (canConvert == true)
                    {
                        intmarkSubject = (intmarkSubject * 100) / maxima2;
                        ...
                        if (intmarkSubject >= 50)
                        {
                            xrTableEsthétiquePeriode1.ForeColor = Color.Blue;
                        }
                        else
                        {
                            xrTableEsthétiquePeriode1.ForeColor = Color.Red;
                        }
                    }
                    ...
                    xrTableEducationLaViePeriode2.Text = pointArrayGlobalVariable[3, 1]; //Ed. Civ. & Morale
                    ...
                    xrTableEdCivMoraleEducationLaViePeriode2.Text = pointArrayGlobalVariable[4, 1]; //Education à la Vie
                    stmarkSubject = xrTableEdCivMoraleEducationLaViePeriode2.Text;
                    canConvert = int.TryParse(stmarkSubject, out intmarkSubject);
                    if (canConvert == true)
                    {
                        intmarkSubject = (intmarkSubject * 100) / maxima1;
                        ...
                        if (intmarkSubject >= 50)
                        {
                            xrTableEdCivMoraleEducationLaViePeriode2.ForeColor = Color.Blue;
                        }
                        else
                        {
                            xrTableEdCivMoraleEducationLaViePeriode2.ForeColor = Color.Red;
                        }
                    }
                    ...
                    xrTableBiologiePeriode2.Text = pointArrayGlobalVariable[7, 1]; //Microbiologie (1)
                    stmarkSubject = xrTableBiologiePeriode2.Text;
                    canConvert = int.TryParse(stmarkSubject, out intmarkSubject);
                    if (canConvert == true)
                    {
                        intmarkSubject = (intmarkSubject * 100) / maxima2;
                        ...
                        if (intmarkSubject >= 50)
                        {
                            xrTableBiologiePeriode2.ForeColor = Color.Blue;
                        }
                        else
                        {
                            xrTableBiologiePeriode2.ForeColor = Color.Red;
                        }
                    }
                    ...
                    xrTableEsthétiquePeriode2.Text = pointArrayGlobalVariable[14, 1]; //Sociologie / Ecopol (1)
                    stmarkSubject = xrTableEsthétiquePeriode2.Text;
                    canConvert = int.TryParse(stmarkSubject, out intmarkSubject);
                    if (canConvert == true)
                    {
                        intmarkSubject = (intmarkSubject * 100) / maxima2;
                        ...
                        if (intmarkSubject >= 50)
                        {
                            xrTableEsthétiquePeriode2.ForeColor = Color.Blue;
                        }
                        else
                        {
                            xrTableEsthétiquePeriode2.ForeColor = Color.Red;
                        }
                    }
                    ...
                    xrTableEducationLaVieSemester1Exam.Text = pointArrayGlobalVariable[3, 2]; //Ed. Civ. & Morale
                    ...
                    xrTableEdCivMoraleEducationLaVieSemester1Exam.Text = pointArrayGlobalVariable[4, 2]; //Education à la Vie
                    stmarkSubject = xrTableEdCivMoraleEducationLaVieSemester1Exam.Text;
                    canConvert = int.TryParse(stmarkSubject, out intmarkSubject);
                    if (canConvert == true)
                    {
                        intmarkSubject = (intmarkSubject * 100) / maximaEx1;
                        ...
                        if (intmarkSubject >= 50)
                        {
                            xrTableEdCivMoraleEducationLaVieSemester1Exam.ForeColor = Color.Blue;
                        }
                        else
                        {
                            xrTableEdCivMoraleEducationLaVieSemester1Exam.ForeColor = Color.Red;
                        }
                    }
                    ...
                    xrTableBiologieSemester1Exam.Text = pointArrayGlobalVariable[7, 2]; //Microbiologie (1)
                    stmarkSubject = xrTableBiologieSemester1Exam.Text;
                    canConvert = int.TryParse(stmarkSubject, out intmarkSubject);
                    if (canConvert == true)
                    {
                        ...
                        if (intmarkSubject >= 50)
                        {
                            xrTableBiologieSemester1Exam.ForeColor = Color.Blue;
                        }
                        else
                        {
                            xrTableBiologieSemester1Exam.ForeColor = Color.Red;
                        }
                    }
                    ...
                    xrTableEsthétiqueExamSemester1.Text = pointArrayGlobalVariable[14, 2]; //Sociologie / Ecopol (1)
                    stmarkSubject = xrTableEsthétiqueExamSemester1.Text;
                    canConvert = int.TryParse(stmarkSubject, out intmarkSubject);
                    if (canConvert == true)
                    {
                        intmarkSubject = (intmarkSubject * 100) / maximaEx2;
                        ...
                        if (intmarkSubject >= 50)
                        {
                            xrTableEsthétiqueExamSemester1.ForeColor = Color.Blue;
                        }
                        else
                        {
                            xrTableEsthétiqueExamSemester1.ForeColor = Color.Red;
                        }
                    }
                    ...
                    xrTableEducationLaViePeriode3.Text = pointArrayGlobalVariable[3, 3]; //Ed. Civ. & Morale
                    ...
                    xrTableEdCivMoraleEducationLaViePeriode3.Text = pointArrayGlobalVariable[4, 3]; //Education à la Vie
                    stmarkSubject = xrTableEdCivMoraleEducationLaViePeriode3.Text;
                    canConvert = int.TryParse(stmarkSubject, out intmarkSubject);
                    if (canConvert == true)
                    {
                        intmarkSubject = (intmarkSubject * 100) / maxima1;
                        ...
                        if (intmarkSubject >= 50)
                        {
                            xrTableEdCivMoraleEducationLaViePeriode3.ForeColor = Color.Blue;
                        }
                        else
                        {
                            xrTableEdCivMoraleEducationLaViePeriode3.ForeColor = Color.Red;
                        }
                    }
                    ...
                    xrTableBiologiePeriode3.Text = pointArrayGlobalVariable[7, 3]; //Microbiologie (1)
                    stmarkSubject = xrTableBiologiePeriode3.Text;
                    canConvert = int.TryParse(stmarkSubject, out intmarkSubject);
                    if (canConvert == true)
                    {
                        intmarkSubject = (intmarkSubject * 100) / maxima2;
                        ...
                        if (intmarkSubject >= 50)
                        {
                            xrTableBiologiePeriode3.ForeColor = Color.Blue;
                        }
                        else
                        {
                            xrTableBiologiePeriode3.ForeColor = Color.Red;
                        }
                    }
                    ...
                    xrTableEsthétiquePeriode3.Text = pointArrayGlobalVariable[14, 3]; //Sociologie / Ecopol (1)
                    stmarkSubject = xrTableEsthétiquePeriode3.Text;
                    canConvert = int.TryParse(stmarkSubject, out intmarkSubject);
                    if (canConvert == true)
                    {
                        intmarkSubject = (intmarkSubject * 100) / maxima2;
                        ...
                        if (intmarkSubject >= 50)
                        {
                            xrTableEsthétiquePeriode3.ForeColor = Color.Blue;
                        }
                        else
                        {
                            xrTableEsthétiquePeriode3.ForeColor = Color.Red;
                        }
                    }
                    ...
                    xrTableEducationLaViePeriode4.Text = pointArrayGlobalVariable[3, 4]; //Ed. Civ. & Morale
                    ...
                    xrTableEdCivMoraleEducationLaViePeriode4.Text = pointArrayGlobalVariable[4, 4]; //Education à la Vie
                    stmarkSubject = xrTableEdCivMoraleEducationLaViePeriode4.Text;
                    canConvert = int.TryParse(stmarkSubject, out intmarkSubject);
                    if (canConvert == true)
                    {
                        intmarkSubject = (intmarkSubject * 100) / maxima1;
                        ...
                        if (intmarkSubject >= 50)
                        {
                            xrTableEdCivMoraleEducationLaViePeriode4.ForeColor = Color.Blue;
                        }
                        else
                        {
                            xrTableEdCivMoraleEducationLaViePeriode4.ForeColor = Color.Red;
                        }
                    }
                    ...
                    xrTableBiologiePeriode4.Text = pointArrayGlobalVariable[7, 4]; //Microbiologie (1)
                    stmarkSubject = xrTableBiologiePeriode4.Text;
                    canConvert = int.TryParse(stmarkSubject, out intmarkSubject);
                    if (canConvert == true)
                    {
                        intmarkSubject = (intmarkSubject * 100) / maxima2;
                        ...
                        if (intmarkSubject >= 50)
                        {
                            xrTableBiologiePeriode4.ForeColor = Color.Blue;
                        }
                        else
                        {
                            xrTableBiologiePeriode4.ForeColor = Color.Red;
                        }
                    }
                    ...
                    xrTableEsthétiquePeriode4.Text = pointArrayGlobalVariable[14, 4]; //Sociologie / Ecopol (1)
                    stmarkSubject = xrTableEsthétiquePeriode4.Text;
                    canConvert = int.TryParse(stmarkSubject, out intmarkSubject);
                    if (canConvert == true)
                    {
                        intmarkSubject = (intmarkSubject * 100) / maxima2;
                        ...
                        if (intmarkSubject >= 50)
                        {
                            xrTableEsthétiquePeriode4.ForeColor = Color.Blue;
                        }
                        else
                        {
                            xrTableEsthétiquePeriode4.ForeColor = Color.Red;
                        }
                    }
                    ...
                    xrTableEducationLaVieSemester2Exam.Text = pointArrayGlobalVariable[3, 5]; //Ed. Civ. & Morale
                    ...
                    xrTableEdCivMoraleEducationLaVieSemester2Exam.Text = pointArrayGlobalVariable[4, 5]; //Education à la Vie
                    stmarkSubject = xrTableEdCivMoraleEducationLaVieSemester2Exam.Text;
                    canConvert = int.TryParse(stmarkSubject, out intmarkSubject);
                    if (canConvert == true)
                    {
                        intmarkSubject = (intmarkSubject * 100) / maximaEx1;
                        ...
                        if (intmarkSubject >= 50)
                        {
                            xrTableEdCivMoraleEducationLaVieSemester2Exam.ForeColor = Color.Blue;
                        }
                        else
                        {
                            xrTableEdCivMoraleEducationLaVieSemester2Exam.ForeColor = Color.Red;
                        }
                    }
                    ...
                    xrTableBiologieSemester2Exam.Text = pointArrayGlobalVariable[7, 5]; //Microbiologie (1)                   
                    stmarkSubject = xrTableBiologieSemester2Exam.Text;
                    canConvert = int.TryParse(stmarkSubject, out intmarkSubject);
                    if (canConvert == true)
                    {
                        intmarkSubject = (intmarkSubject * 100) / maximaEx2;
                        ...
                        if (intmarkSubject >= 50)
                        {
                            xrTableBiologieSemester2Exam.ForeColor = Color.Blue;
                        }
                        else
                        {
                            xrTableBiologieSemester2Exam.ForeColor = Color.Red;
                        }
                    }
                    ...
                    xrTableEsthétiqueExamSemester2.Text = pointArrayGlobalVariable[14, 5]; //Sociologie / Ecopol (1)
                    stmarkSubject = xrTableEsthétiqueExamSemester2.Text;
                    canConvert = int.TryParse(stmarkSubject, out intmarkSubject);
                    if (canConvert == true)
                    {
                        intmarkSubject = (intmarkSubject * 100) / maximaEx2;
                        ...
                        if (intmarkSubject >= 50)
                        {
                            xrTableEsthétiqueExamSemester2.ForeColor = Color.Blue;
                        }
                        else
                        {
                            xrTableEsthétiqueExamSemester2.ForeColor = Color.Red;
                        }
                    }
                    ...
                    xrTableEducationLaVieSemester1Tot.Text = pointArrayGlobalVariable[3, 9]; //Ed. Civ. & Morale
                    ...
                    xrTableEdCivMoraleEducationLaVieSemester1Tot.Text = pointArrayGlobalVariable[4, 9]; //Education à la Vie
                    stmarkSubject = xrTableEdCivMoraleEducationLaVieSemester1Tot.Text;
                    canConvert = int.TryParse(stmarkSubject, out intmarkSubject);
                    if (canConvert == true)
                    {
                        intmarkSubject = (intmarkSubject * 100) / maximaTot1;
                        ...
                        if (intmarkSubject >= 50)
                        {
                            xrTableEdCivMoraleEducationLaVieSemester1Tot.ForeColor = Color.Blue;
                        }
                        else
                        {
                            xrTableEdCivMoraleEducationLaVieSemester1Tot.ForeColor = Color.Red;
                        }
                    }
                    ...
                    xrTableBiologieSemester1Tot.Text = pointArrayGlobalVariable[7, 9]; //Microbiologie (1)
                    stmarkSubject = xrTableBiologieSemester1Tot.Text;
                    canConvert = int.TryParse(stmarkSubject, out intmarkSubject);
                    if (canConvert == true)
                    {
                        ...
                        if (intmarkSubject >= 50)
                        {
                            xrTableBiologieSemester1Tot.ForeColor = Color.Blue;
                        }
                        else
                        {
                            xrTableBiologieSemester1Tot.ForeColor = Color.Red;
                        }
                    }
                    ...
                    xrTableEsthétiqueTotSemester1.Text = pointArrayGlobalVariable[14, 9]; //Sociologie / Ecopol (1)
                    stmarkSubject = xrTableEsthétiqueTotSemester1.Text;
                    canConvert = int.TryParse(stmarkSubject, out intmarkSubject);
                    if (canConvert == true)
                    {
                        intmarkSubject = (intmarkSubject * 100) / maximaTot2;
                        ...
                        if (intmarkSubject >= 50)
                        {
                            xrTableEsthétiqueTotSemester1.ForeColor = Color.Blue;
                        }
                        else
                        {
                            xrTableEsthétiqueTotSemester1.ForeColor = Color.Red;
                        }
                    }
                    ...
                    xrTableEducationLaVieSemester2Tot.Text = pointArrayGlobalVariable[3, 10]; //Ed. Civ. & Morale
                    ...
                    xrTableEdCivMoraleEducationLaVieSemester2Tot.Text = pointArrayGlobalVariable[4, 10]; //Education à la Vie
                    stmarkSubject = xrTableEdCivMoraleEducationLaVieSemester2Tot.Text;
                    canConvert = int.TryParse(stmarkSubject, out intmarkSubject);
                    if (canConvert == true)
                    {
                        intmarkSubject = (intmarkSubject * 100) / maximaTot1;
                        ...
                        if (intmarkSubject >= 50)
                        {
                            xrTableEdCivMoraleEducationLaVieSemester2Tot.ForeColor = Color.Blue;
                        }
                        else
                        {
                            xrTableEdCivMoraleEducationLaVieSemester2Tot.ForeColor = Color.Red;
                        }
                    }
                    ...
                    xrTableBiologieSemester2Tot.Text = pointArrayGlobalVariable[7, 10]; //Microbiologie (1)
                    stmarkSubject = xrTableBiologieSemester2Tot.Text;
                    canConvert = int.TryParse(stmarkSubject, out intmarkSubject);
                    if (canConvert == true)
                    {
                        intmarkSubject = (intmarkSubject * 100) / maximaTot2;
                        ...
                        if (intmarkSubject >= 50)
                        {
                            xrTableBiologieSemester2Tot.ForeColor = Color.Blue;
                        }
                        else
                        {
                            xrTableBiologieSemester2Tot.ForeColor = Color.Red;
                        }
                    }
                    ...
                    xrTableEsthétiqueTotSemester2.Text = pointArrayGlobalVariable[14, 10]; //Sociologie / Ecopol (1)
                    stmarkSubject = xrTableEsthétiqueTotSemester2.Text;
                    canConvert = int.TryParse(stmarkSubject, out intmarkSubject);
                    if (canConvert == true)
                    {
                        intmarkSubject = (intmarkSubject * 100) / maximaTot2;
                        ...
                        if (intmarkSubject >= 50)
                        {
                            xrTableEsthétiqueTotSemester2.ForeColor = Color.Blue;
                        }
                        else
                        {
                            xrTableEsthétiqueTotSemester2.ForeColor = Color.Red;
                        }
                    }
                    ...
                    xrTableEducationLaVieTotGen.Text = pointArrayGlobalVariable[3, 12]; //Ed. Civ. & Morale
                    ...
                    xrTableEdCivMoraleEducationLaVieTotGen.Text = pointArrayGlobalVariable[4, 12]; //Education à la Vie
                    stmarkSubject = xrTableEdCivMoraleEducationLaVieTotGen.Text;
                    canConvert = int.TryParse(stmarkSubject, out intmarkSubject);
                    if (canConvert == true)
                    {
                        intmarkSubject = (intmarkSubject * 100) / maximaTotGen1;
                        ...
                        if (intmarkSubject >= 50)
                        {
                            xrTableEdCivMoraleEducationLaVieTotGen.ForeColor = Color.Blue;
                        }
                        else
                        {
                            xrTableEdCivMoraleEducationLaVieTotGen.ForeColor = Color.Red;
                        }
                    }
                    ...
                    xrTableBiologieTotGen.Text = pointArrayGlobalVariable[7, 12]; //Microbiologie (1)
                    stmarkSubject = xrTableBiologieTotGen.Text;
                    canConvert = int.TryParse(stmarkSubject, out intmarkSubject);
                    if (canConvert == true)
                    {
                        ...
                        if (intmarkSubject >= 50)
                        {
                            xrTableBiologieTotGen.ForeColor = Color.Blue;
                        }
                        else
                        {
                            xrTableBiologieTotGen.ForeColor = Color.Red;
                        }
                    }
                    ...
                    xrTableEsthétiqueTotGen.Text = pointArrayGlobalVariable[14, 12]; //Sociologie / Ecopol (1)
                    stmarkSubject = xrTableEsthétiqueTotGen.Text;
                    canConvert = int.TryParse(stmarkSubject, out intmarkSubject);
                    if (canConvert == true)
                    {
                        intmarkSubject = (intmarkSubject * 100) / maximaTotGen2;
                        ...
                        if (intmarkSubject >= 50)
                        {
                            xrTableEsthétiqueTotGen.ForeColor = Color.Blue;
                        }
                        else
                        {
                            xrTableEsthétiqueTotGen.ForeColor = Color.Red;
                        }
                    }
