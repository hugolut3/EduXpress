...
namespace EduXpress.Education
{
    public partial class userControlSubjectsDRC : DevExpress.XtraEditors.XtraUserControl, Functions.IMergeRibbons
    {
        ...
        private void autoCompleteSubjects()
        {
            AutoCompleteStringCollection col = new AutoCompleteStringCollection();

            col.Add("Anglais");
            col.Add("Act. man./Ecriture");
            col.Add("Activités compl. (Visites guidées)");
            col.Add("Biologie");
            col.Add("Biologie Hygiène");
            col.Add("Chimie");
            col.Add("Comptabilité Générale");
            col.Add("Correspondance com. Angl.");
            col.Add("Correspondance com. Franc.");
            col.Add("Dessin pédagogique");
            col.Add("Dessin / Trav.Ma./ Ecrit.");            
            col.Add("Didactique des disciplines");
            col.Add("Didactique Générale");            
            col.Add("Documentation commerciale");
            col.Add("Droit");
            col.Add("Ed. Civ. & Morale");
            col.Add("Ed. Musicale/Theatre");            
            col.Add("Education à la Vie");
            col.Add("Education Physique");
            col.Add("Fiscalité");
            col.Add("Français");
            col.Add("Géographie");
            col.Add("Géographie économique");
            col.Add("Histoire");
            col.Add("Informatique");
            col.Add("Initiation Esthétique");
            col.Add("Langue Nationales");            
            col.Add("Latin");
            col.Add("Mathématiques");
            col.Add("Mathématiques financières");
            col.Add("Mathématiques Générales");
            col.Add("Microbiologie");
            col.Add("Pédagogie");
            col.Add("Philosophie");
            col.Add("Physique");
            col.Add("Pratique d'enseignement");            
            col.Add("Pratique Professionnelle");
            col.Add("Psychologie");            
            col.Add("Religion");
            col.Add("Sociologie / Ecopol");

            col.Add("Algèbre");                //8em and 7em SEC
            col.Add("Arithmétiques");
            col.Add("Géométrie");
            col.Add("Statistique");
            col.Add("Anatomie");
            col.Add("Botanique");
            col.Add("Zoologie");
            col.Add("Sciences Physiques");
            col.Add("Technologie");
            col.Add("Techn. d'Info. & Com (TIC)");
            col.Add("Dessin");
            col.Add("Musique");

            col.Add("Lecture");               //6em Prim
            col.Add("Gram. & Conj.");
            col.Add("Rédaction");
            col.Add("Exp. Orale & Vocab.");
            col.Add("Exp. Orale & Rédaction");
            col.Add("Orthographe");
            col.Add("Problèmes");
            col.Add("Formes Géométriques");
            col.Add("Mesures des grandeurs");
            col.Add("Numérations");
            col.Add("Anatomie / botanique");
            col.Add("Opérations");

            col.Add("Correspondance com. Anglaise");  //4e Comercial
            col.Add("Correspondance com. Française");
            col.Add("Déontologie professionnelle");
            col.Add("Finances publiques");
            col.Add("Economie de développement");
            col.Add("Organisation des entreprises");
            col.Add("Comptabilité analytique");

            col.Add("Ed. phys. & sportive");               //4em Prim
            col.Add("Init. Trav. Prod.");
            col.Add("Numérations & Informatique");

            col.Add("Esthétique");                         //3em BIOCH

            col.Add("Algèbre, Stat. et Analy.");           //1ere scientifique
            col.Add("Géom. et Trigo.");
            col.Add("Dessin scientifique");
            col.Add("Biologie générale");
            col.Add("Géologie");
            col.Add("Sociologie africaine");


            txtSubjectName.MaskBox.AutoCompleteSource = AutoCompleteSource.CustomSource;
            txtSubjectName.MaskBox.AutoCompleteCustomSource = col;
            txtSubjectName.MaskBox.AutoCompleteMode = AutoCompleteMode.Suggest;
        }
        ...
        private void btnUpdate_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                using (con = new SqlConnection(databaseConnectionString))
                {
                    ...
                    //execute 2nd query
                    string ct2 = "Update SubjectAssignment set SubjectCode=@d1 where SubjectCode=@d2";
                    ...
                    //execute 3rd query
                    string ct3 = "Update MarksEntry set SubjectCode=@d1 where SubjectCode=@d2";
        ...
        private void DeleteRecord()
        {
            try
            {
                ...
                {
                    con.Open();
                    string cl = "select Subject.SubjectCode, SubjectAssignment.SubjectCode, MarksEntry.SubjectCode " +
                        "from Subject ,SubjectAssignment,MarksEntry " +
                        "where Subject.SubjectCode=SubjectAssignment.SubjectCode and Subject.SubjectCode=MarksEntry.SubjectCode " +
                        "and Subject.SubjectCode=@d1";
                    ...
                    if (rdr.Read())
                    {
                        XtraMessageBox.Show(LocRM.GetString("strUnableDeleteSubject"), LocRM.GetString("strError"), MessageBoxButtons.OK, MessageBoxIcon.Error);
                        if (rdr != null)
                            rdr.Close();
                        return;
                    }
