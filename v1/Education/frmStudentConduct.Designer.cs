namespace EduXpress.Education
{
    partial class frmStudentConduct
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnGetConducts.ImageOptions.ImageIndex = ((int)(resources.GetObject("btnGetConducts.ImageOptions.ImageIndex")));
            this.btnGetConducts.ImageOptions.LargeImageIndex = ((int)(resources.GetObject("btnGetConducts.ImageOptions.LargeImageIndex")));
            ...
            this.gridControlStudentConduct.EmbeddedNavigator.AccessibleDescription = resources.GetString("gridControlStudentConduct.EmbeddedNavigator.AccessibleDescription");
            this.gridControlStudentConduct.EmbeddedNavigator.AccessibleName = resources.GetString("gridControlStudentConduct.EmbeddedNavigator.AccessibleName");
            this.gridControlStudentConduct.EmbeddedNavigator.AllowHtmlTextInToolTip = ((DevExpress.Utils.DefaultBoolean)(resources.GetObject("gridControlStudentConduct.EmbeddedNavigator.AllowHtmlTextInToolTip")));
            this.gridControlStudentConduct.EmbeddedNavigator.Anchor = ((System.Windows.Forms.AnchorStyles)(resources.GetObject("gridControlStudentConduct.EmbeddedNavigator.Anchor")));
            this.gridControlStudentConduct.EmbeddedNavigator.BackgroundImage = ((System.Drawing.Image)(resources.GetObject("gridControlStudentConduct.EmbeddedNavigator.BackgroundImage")));
            this.gridControlStudentConduct.EmbeddedNavigator.BackgroundImageLayout = ((System.Windows.Forms.ImageLayout)(resources.GetObject("gridControlStudentConduct.EmbeddedNavigator.BackgroundImageLayout")));
            this.gridControlStudentConduct.EmbeddedNavigator.ImeMode = ((System.Windows.Forms.ImeMode)(resources.GetObject("gridControlStudentConduct.EmbeddedNavigator.ImeMode")));
            this.gridControlStudentConduct.EmbeddedNavigator.MaximumSize = ((System.Drawing.Size)(resources.GetObject("gridControlStudentConduct.EmbeddedNavigator.MaximumSize")));
            this.gridControlStudentConduct.EmbeddedNavigator.TextLocation = ((DevExpress.XtraEditors.NavigatorButtonsTextLocation)(resources.GetObject("gridControlStudentConduct.EmbeddedNavigator.TextLocation")));
            this.gridControlStudentConduct.EmbeddedNavigator.ToolTip = resources.GetString("gridControlStudentConduct.EmbeddedNavigator.ToolTip");
            this.gridControlStudentConduct.EmbeddedNavigator.ToolTipIconType = ((DevExpress.Utils.ToolTipIconType)(resources.GetObject("gridControlStudentConduct.EmbeddedNavigator.ToolTipIconType")));
            this.gridControlStudentConduct.EmbeddedNavigator.ToolTipTitle = resources.GetString("gridControlStudentConduct.EmbeddedNavigator.ToolTipTitle");
