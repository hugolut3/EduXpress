...
namespace EduXpress
{
    ...
    public partial class Form1 : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        public Form1()
        {
            ...
            navBarItemMarkSheet.LinkClicked += (s, ee) => { navFrameEducation.SelectedPageIndex = 0; ucControlMarkSheet.MergeRibbon(); ucControlMarkSheet.MergeStatusBar(); ribbonControlMain.SelectedPage = ribbonControlMain.MergedPages[0]; ribbonPageHelp.MergeOrder = 3; };
            navBarItemSubjects.LinkClicked += (s, ee) => { navFrameEducation.SelectedPageIndex = 1; ucControlSubjects.MergeRibbon(); ucControlSubjects.MergeStatusBar(); ribbonControlMain.SelectedPage = ribbonControlMain.MergedPages[0]; ribbonPageHelp.MergeOrder = 3; };            
        ...
        private void ShowLoginForm()
        {
           ...
           // frm.ActiveControl = txtUserName;
            ...
            if (userChoice == DialogResult.OK)
            {
                ...
                if (Role == 13) //Teacher Administrator
                {
                    showMenuTeacherAdministrator();
                    barStaticUser.Caption = "";
                    barStaticUser.Caption = UserLoggedSurname.ToUpper() + " " + UserLoggedName.ToUpper() + " " + LocRM.GetString("strLoggedIn");
                }
        ...
        private void showMenuAdmin()
        {
            ...
            if (LicenseFeature == "0".Trim()) //3 months Trial version with all current modules
            {
                ...
                navBarGroupEducation.Visible = true; // Education Menu
                navBarItemSubjects.Visible = true; // student subjects
                navBarItemReportCards.Visible = true; //  student Bulletin
            ...
            if (LicenseFeature == "2".Trim()) //Standard Version: Module de base only
            {
                ...
                navBarGroupEducation.Visible = false; // Education Menu
                navBarItemSubjects.Visible = false; // student subjects
                navBarItemReportCards.Visible = false; //  student Bulletin
        ...
        private void showMenuAccountant()
        {
            ...
            if (LicenseFeature == "0".Trim()) //3 months Trial version with all current modules
            {
                ...
                navBarItemSMS.Visible = false; // Settings SMS
                navBarItemPrinters.Visible = false; // Settings Printers
                navBarItemConfigurationWizard.Visible = false; // Configuration Wizard
                officeNavigationBarMain.Visible = true;
                //                
                navBarItemSpreadsheet.Visible = true; // office Spread sheet
                navBarItemScheduling.Visible = true; // office Scheduling
        ...
        private void showMenuTeacher()
        {
            ...
            if (LicenseFeature == "0".Trim()) //3 months Trial version with all current modules
            {
                ...
                navBarItemStudents.Visible = false;//Student Home dashboard
                navBarItemFeesCollected.Visible = false;//Fees Collected Home dashboard
                navBarGroupStudents.Visible = false; // student Menu
                navBarGroupEducation.Visible = true; // Education Menu
                navBarItemSubjects.Visible = false; // student subjects
                navBarItemReportCards.Visible = false; //  student Bulletin
        ...
        //Login as a normal teacher admin
        private void showMenuTeacherAdministrator()
        {
            //Show Admin menu based on license
            if (LicenseFeature == "0".Trim()) //3 months Trial version with all current modules
            {
        ...
        private void navBarItem1_LinkClicked(object sender, DevExpress.XtraNavBar.NavBarLinkEventArgs e)
        {
            Cursor = Cursors.WaitCursor;
            timer1.Enabled = true;
            Admin.frmCloudSettings frm = new Admin.frmCloudSettings();
            frm.ShowDialog();
        }
