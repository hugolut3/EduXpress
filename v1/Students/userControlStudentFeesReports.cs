...
{
    public partial class userControlStudentFeesReports : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        ResourceManager LocRM = new ResourceManager("EduXpress.Language.EduXpressStrings", typeof(userControlStudentFeesReports).Assembly);
        ...
        public userControlStudentFeesReports()
        {
            InitializeComponent();
        }
            ...
            try
            {
                ...
                using (con = new SqlConnection(databaseConnectionString))
                {
                    ...
                    string ct = "SELECT RTRIM(Students.StudentNumber),RTRIM(StudentSurname),RTRIM(StudentFirstNames),RTRIM(Class)," +
                        ...
                        "and CourseFeePayment.CourseFeePaymentID = CourseFeePayment_Join.C_PaymentID and Employee=@d2 " +
                        "order by StudentSurname,Students.StudentNumber";
                    cmd = new SqlCommand(ct);
                    cmd.Connection = con;

                    cmd.Parameters.Add("@d2", SqlDbType.NChar, 80, "Employee").Value = UserLoggedSurname;
        ...
        private void userControlStudentFeesReports_VisibleChanged(object sender, EventArgs e)
        {
        ...
        private void filterPaymentTodayCashier()
        {
            try
            {
                ...
                searchbyCashier = UserLoggedSurname + " "+ UserLoggedName;
                studentSearchBy = 6;                
        ...
        private void filterPaymentThisWeekCashier()
        {
            try
            {
                ...
                using (con = new SqlConnection(databaseConnectionString))
                {
                    ...
                    cmd.Parameters.Add("@d3", SqlDbType.NChar, 80, "Employee").Value = UserLoggedSurname;
        ...
        private void btnExportExcel_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (gridView1.DataRowCount > 0)
            {
                ...
                try
                {
                   ...
                   Reports.reportFeePayment report = new Reports.reportFeePayment();
        ...
        private void userControlStudentFeesReports_Load(object sender, EventArgs e)
        {
            comboDefinedDate.Properties.AdvancedModeOptions.Label = LocRM.GetString("strPeriod") + ": ";
            dtFrom.Properties.AdvancedModeOptions.Label = LocRM.GetString("strFrom") + ": ";
