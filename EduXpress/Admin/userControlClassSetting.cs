    ...
    public partial class userControlClassSetting : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void btnSaveClass_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                using (con = new SqlConnection(databaseConnectionString))
                {
                    ...
                    string cb = "insert into Classes(ClassName,SectionName,SectionAbrev,Cycle ) VALUES (@d1,@d2,@d3,@d4)";
        ...
        public DataView Getdata()
        {
            ...
            dynamic SelectQry = "SELECT  RTRIM(ClassName) as [" + ClassColumn + "], RTRIM(SectionName) as [" + SectionColumn + "], " +
                ...
                "RTRIM(Cycle) as [" + CycleColumn + "] FROM Classes order by ClassName";
        ...
        private void btnUpdate_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                using (con = new SqlConnection(databaseConnectionString))
                {
                    ...
                    //execute 1st query
                    string ct1 = "Update Classes set ClassName=@d1,SectionName=@d2,SectionAbrev=@d3 ,Cycle=@d4 where ClassName=@d5";
        ...
        private void DeleteRecord()
        {
            try
            {
                ...
                {
                    con.Open();
                    string cl = "select Classes.ClassName, Students.Class from Classes ,Students where Classes.ClassName=Students.Class and Classes.ClassName=@d1";
