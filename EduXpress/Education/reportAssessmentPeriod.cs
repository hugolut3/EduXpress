...
{
    public partial class reportAssessmentPeriod : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        ResourceManager LocRM = new ResourceManager("EduXpress.Language.EduXpressStrings", typeof(reportAssessmentPeriod).Assembly);
        public reportAssessmentPeriod()
        {
            InitializeComponent();
        }

        private void reportAssessmentPeriod_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            xrLblTeacher.Text = LocRM.GetString("strTeacher").ToUpper() + ": " + UserLoggedSurname.ToUpper() + " " + UserLoggedName.ToUpper();
                ...
                xrLblAssessmentPeriodTitle.Text = LocRM.GetString("strReportPeriodAssessmentBySubject").ToUpper();
